package com.abkhrr.movieeplot.utils.android.pager
...
class CirclePagerIndicator : RecyclerView.ItemDecoration() {
    ...
    private fun drawInactiveIndicators(
        ...
        mPaint.color = ContextCompat.getColor(context, R.color.COLOR_STEPPER_LINE)
    ...
    private fun drawHighlights(
        context: Context, c: Canvas, indicatorStartX: Float, indicatorPosY: Float,
        highlightPosition: Int, progress: Float, itemCount: Int
    ) {
        mPaint.color = ContextCompat.getColor(context, R.color.COLOR_STEPPER_POSITIVE)
